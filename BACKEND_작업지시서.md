...
2. **Trust Project** → Maven import 완료 대기
...
| Maven import 실패 | JDK 버전 | JDK 17 설정 |
| Module not found (IntelliJ) | Maven import 미완료 | Maven Reload |
